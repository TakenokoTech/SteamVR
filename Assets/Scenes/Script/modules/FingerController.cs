...
public class FingerController : MonoBehaviour {
    ...
    private static readonly Dictionary<FingerType, Dictionary<HumanBodyBones, Vector3>> FingerBoneMap = new Dictionary<FingerType, Dictionary<HumanBodyBones, Vector3>> {
        {
        FingerType.LeftIndex, new Dictionary<HumanBodyBones, Vector3> { { HumanBodyBones.LeftIndexProximal, new Vector3 (10f, 0f, 70f) },
        { HumanBodyBones.LeftIndexIntermediate, new Vector3 (10f, 20f, 70f) },
        { HumanBodyBones.LeftIndexDistal, new Vector3 (0f, 0f, 90f) },
        }
        },
        {
        FingerType.LeftMiddle,
        new Dictionary<HumanBodyBones, Vector3> { { HumanBodyBones.LeftMiddleProximal, new Vector3 (0f, 0f, 80f) },
        ...
        {
        FingerType.LeftRing,
        new Dictionary<HumanBodyBones, Vector3> { { HumanBodyBones.LeftRingProximal, new Vector3 (-10f, 0f, 80f) },
        { HumanBodyBones.LeftRingIntermediate, new Vector3 (0f, 0f, 70f) },
        { HumanBodyBones.LeftRingDistal, new Vector3 (-15f, 0f, 90f) },
        }
        },
        {
        FingerType.LeftLittle,
        new Dictionary<HumanBodyBones, Vector3> { { HumanBodyBones.LeftLittleProximal, new Vector3 (-20f, 0f, 80f) },
        { HumanBodyBones.LeftLittleIntermediate, new Vector3 (0f, 0f, 70f) },
        { HumanBodyBones.LeftLittleDistal, new Vector3 (-30f, 0f, 90f) },
        }
        },

        {
        FingerType.RightIndex,
        new Dictionary<HumanBodyBones, Vector3> { { HumanBodyBones.RightIndexProximal, new Vector3 (10f, 0f, -70f) },
        { HumanBodyBones.RightIndexIntermediate, new Vector3 (10f, -20f, -70f) },
        { HumanBodyBones.RightIndexDistal, new Vector3 (0f, 0f, -90f) },
        }
        },
        {
        FingerType.RightMiddle,
        new Dictionary<HumanBodyBones, Vector3> { { HumanBodyBones.RightMiddleProximal, new Vector3 (0f, 0f, -80f) },
        ...
        new Dictionary<HumanBodyBones, Vector3> { { HumanBodyBones.RightRingProximal, new Vector3 (-10f, 0f, -80f) },
        { HumanBodyBones.RightRingIntermediate, new Vector3 (0f, 0f, -70f) },
        { HumanBodyBones.RightRingDistal, new Vector3 (-15f, 0f, -90f) },
        }
        },
        {
        FingerType.RightLittle,
        new Dictionary<HumanBodyBones, Vector3> { { HumanBodyBones.RightLittleProximal, new Vector3 (-20f, 0f, -80f) },
        { HumanBodyBones.RightLittleIntermediate, new Vector3 (0f, 0f, -70f) },
        { HumanBodyBones.RightLittleDistal, new Vector3 (-30f, 0f, -90f) },
        }
        },

        {
        FingerType.LeftThumb,
        new Dictionary<HumanBodyBones, Vector3> { { HumanBodyBones.LeftThumbProximal, new Vector3 (30f, -90f, 10f) },
        { HumanBodyBones.LeftThumbIntermediate, new Vector3 (0f, 0f, 0f) },
        { HumanBodyBones.LeftThumbDistal, new Vector3 (0f, -90f, 0f) },
        }
        },

        {
        FingerType.RightThumb,
        new Dictionary<HumanBodyBones, Vector3> { { HumanBodyBones.RightThumbProximal, new Vector3 (30f, 90f, -10f) },
        { HumanBodyBones.RightThumbIntermediate, new Vector3 (0f, 0f, 0f) },
        { HumanBodyBones.RightThumbDistal, new Vector3 (0f, 90f, 0f) },
        }
        },
    };
